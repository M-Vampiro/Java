...
public class DemoNumber {
  public static void main(String[] args) {
    ...
    System.out.println(n1.shortValue()); // -5536

    // Long, Short, Byte, Interger
    BigInteger bi1 = add(1, 3);
    BigInteger bi2 = add(2, 3);
    System.out.println(bi1.compareTo(bi2));

    System.out.println(bi1.compareTo(BigInteger.valueOf(Byte.MAX_VALUE)));
  ...
  public static BigInteger add(Number x, Number y) {
    ...
    long l2 = 0L;
    if (y instanceof Long) { // true -> means, the object of x is created by Long.class
      l2 = (Long) y;
