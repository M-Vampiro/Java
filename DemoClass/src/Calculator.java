...
public class Calculator {
  ...
  public double subtract() { // 0.2 - 0.1 = 0.3
    return this.x.subtract(this.y).doubleValue();
  }

  public double multiply() { // 0.2 - 0.1 = 0.3
    return this.x.multiply(this.y).doubleValue();
  }

  public double divide() { // 0.2 - 0.1 = 0.3
    return this.x.divide(this.y).doubleValue();
  }

  public static Calculator of(double x, double y) { // Static method connect to Constructor
    // Easier to Use
